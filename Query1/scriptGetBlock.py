...
crimes = crimes.sample(n = 5000, random_state=2)                    #taking random sample of size 1000 from the original file | random_state(for reproducibility) will reproduce same random rows each time
